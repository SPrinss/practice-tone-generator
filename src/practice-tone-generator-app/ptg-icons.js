...
$_documentContainer.innerHTML = `<iron-iconset-svg size="24" name="ptg-icons">
  <svg><defs>
    ...
    <g id="flat"><path d="M0,72.3V0h3v46.6c5.3-7.8,10.6-11.7,15.7-11.7c3,0,5.6,1.1,7.8,3.4c2.2,2.3,3.3,5,3.3,8.1c0,6.3-2.7,11.7-8,16.3C16.4,67.4,9.2,70.6,0,72.3z M3,68.8c13.1-3.4,19.6-9.8,19.6-19.5c0-5.9-2.3-8.8-6.8-8.8c-3.8,0-8,3.7-12.7,11V68.8z"></path></g>
    <g id="sharp">
      <path d="M8.4,44.9c0.1-1,0.1-2.4,0.1-4.3c0-1.9,0-3.9,0-6s0-4.1,0-6c0-1.9,0-3.5,0.1-4.6c0-0.5,0.3-1.1,0.8-2
        ...
        c-0.5,0.3-0.9,0.6-1.3,1V55.6z"></path>
    </g>
  </defs></svg>
</iron-iconset-svg>`;
